...
CREATE TABLE HOADON(
	...
	NGLAP_HOADON VARCHAR(10) CONSTRAINT FK_HOAD_NGLHD FOREIGN KEY REFERENCES NHANVIEN(MA_NV) NOT NULL,
	MA_SV VARCHAR(10) CONSTRAINT FK_HOAD_MASV FOREIGN KEY REFERENCES SINHVIEN(MA_SV) NOT NULL,
	PHONGKTX VARCHAR(10) CONSTRAINT FK_HOAD_PHG FOREIGN KEY REFERENCES PHONGKTX(MA_PHONGKTX) NOT NULL,
